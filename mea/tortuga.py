...
obstaculo10 = turtle.Turtle()
obstaculo11= turtle.Turtle()
obstaculo12= turtle.Turtle()
obstaculo13= turtle.Turtle()
...
def obstaculosrandom9 (ser, obstaculo9):
  ...
  obstaculo9.penup()
  obstaculo9.goto (x , y)
def obstaculosrandom10 (ser, obstaculo10):
  obstaculo10.penup()
  x= random.randint(-260-20, 260+20)
  y = random.randint(-260-20, 260+20)
  obstaculo10.penup()
  obstaculo10.goto (x , y)
def obstaculosrandom11 (ser, obstaculo11):
  obstaculo11.penup()
  x= random.randint(-260-20, 260+20)
  y = random.randint(-260-20, 260+20)
  obstaculo11.penup()
  obstaculo11.goto (x , y)
def obstaculosrandom12 (ser, obstaculo12):
  obstaculo12.penup()
  x= random.randint(-260-20, 260+20)
  y = random.randint(-260-20, 260+20)
  obstaculo12.penup()
  obstaculo12.goto (x , y)
def obstaculosrandom13 (ser, obstaculo13):
  obstaculo13.penup()
  x= random.randint(-260-20, 260+20)
  y = random.randint(-260-20, 260+20)
  obstaculo13.penup()
  obstaculo13.goto (x , y)


def colicionobstaculos (ser , obstaculo1 , obstaculo2 , obstaculo3 ,obstaculo4 , obstaculo5 , obstaculo6 , obstaculo7 , obstaculo8 , obstaculo9 , obstaculo10 , obstaculo11 , obstaculo12 , obstaculo13) :
  if (ser.distance(obstaculo1)<  20 or ser.distance(obstaculo2)< 20 or ser.distance(obstaculo3)<20 or ser.distance(obstaculo4)<20 or ser.distance(obstaculo5)< 20 or ser.distance(obstaculo6)<20 or ser.distance(obstaculo7)<20 or ser.distance(obstaculo8)<20 or ser.distance(obstaculo9)<20 or ser.distance(obstaculo10)<20 or ser.distance(obstaculo11)<20 or ser.distance(obstaculo12)<20 or ser.distance(obstaculo13)<20):
        ...
        obstaculosrandom10 (ser, obstaculo10)
        obstaculosrandom11 (ser, obstaculo11)
        obstaculosrandom12(ser, obstaculo12)
        obstaculosrandom13(ser, obstaculo13)
...
while True:
    ...
    dibujo(obstaculo10 , "square", "black", 1 , 1) 
    dibujo(obstaculo11 , "square", "black", 1 , 1) 
    dibujo(obstaculo12 , "square", "black", 1 , 1) 
    dibujo(obstaculo13, "square", "black", 1 , 1)   
    
    if colicionbordes(ser, comida) == 0 or colicioncuerpo(ser,comida) == 0 or colicionobstaculos(ser , obstaculo1 , obstaculo2 , obstaculo3 ,obstaculo4 , obstaculo5 , obstaculo6,obstaculo7,obstaculo8,obstaculo9,obstaculo10,obstaculo11,obstaculo12,obstaculo13) == 0 :
        if score > high_score :
            high_score = score
        score=0 
